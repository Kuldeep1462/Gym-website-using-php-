<?php
include('C:\xampp\htdocs\GymWebsite\database\db_connection.php');
session_start();

// Assuming you have validated the user credentials
$_SESSION['username'] = $username; // Set the username after login validation
